...
$search_query = ''; // Tidak ada search query awal di landing page
$reviews = [];

// --- Logika Pagination ---
$reviews_per_page = 6; // Jumlah ulasan per halaman
...
// Data dummy untuk carousel dan best book (sesuai contoh gambar)
$carousel_books = array_slice($reviews, 0, 6); // Ambil beberapa ulasan terbaru untuk carousel
$best_book_review = isset($reviews[0]) ? $reviews[0] : null; // Ambil ulasan pertama sebagai "Best Book"
$popular_books = array_slice($reviews, 1, 6); // Ambil beberapa ulasan lain untuk popular
...
<head>
    ...
    <title>Recensio - Selamat Datang</title>
...
<body>
    <div class="main-container">
        ...
        <header class="header">
            ...
            <div class="site-branding"> <!-- NEW: Wrapper untuk judul dan tagline -->
        ...
        <nav class="nav-section">
            <div class="nav-tabs">
                <a href="index.php" class="nav-tab active">All</a> <!-- Link ke index.php -->
